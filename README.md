...
![Meridian Electronics customer support chat](./screenshots/chat-ui.jpeg)
...
Use a **Docker** Space or a **custom command** that runs `uvicorn meridian_api.server:app --host 0.0.0.0 --port 7860` with `OPENAI_API_KEY` in Space secrets.
